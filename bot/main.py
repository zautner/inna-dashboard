...
from config import TELEGRAM_BOT_TOKEN, BATCH_SIZE
from database import add_media, get_items_by_status, update_item, get_item
...
async def check_queue_replenishment(context: ContextTypes.DEFAULT_TYPE, chat_id: int):
    ...
    if len(drafts) < BATCH_SIZE:
        ...
        if new_items:
            ...
            await process_single_item(new_items[0], context, chat_id)
